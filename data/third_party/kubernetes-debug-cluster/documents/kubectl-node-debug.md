...
<!-- overview -->
This page shows how to debug a [node](https://kubernetes.io/docs/concepts/architecture/nodes/)
...
Check [debugging a down/unreachable node ](https://kubernetes.io/docs/tasks/debug/debug-cluster/#example-debugging-a-down-unreachable-node)
in that case.
