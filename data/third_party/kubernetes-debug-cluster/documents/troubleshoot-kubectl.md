...
* You also need to have `kubectl` installed - see [install tools](https://kubernetes.io/docs/tasks/tools/#kubectl)
...
[official documentation for installing kubectl](https://kubernetes.io/docs/tasks/tools/#kubectl), and you have
...
Kubernetes supports [multiple clusters and contexts](https://kubernetes.io/docs/tasks/access-application-cluster/configure-access-multiple-clusters/).
