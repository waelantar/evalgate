...
and reports these conditions to the API server as Node [Condition](https://kubernetes.io/docs/concepts/architecture/nodes/#condition)s
or as [Event](https://kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1)s.
...
However, you can use a [`ConfigMap`](https://kubernetes.io/docs/tasks/configure-pod-container/configure-pod-configmap/)
