...
1. My Pods are stuck at "Container Creating" or restarting over and over
   ...
   See [Pause container](https://kubernetes.io/docs/concepts/windows/intro/#pause-container)
...
1. My pods show status as `ErrImgPull` or `ImagePullBackOff`
   ...
   [this guide](https://kubernetes.io/docs/concepts/windows/user-guide/#ensuring-os-specific-workloads-land-on-the-appropriate-container-host).
...
1. My Windows Pods cannot ping external resources
   ...
   (see [Kubernetes model](https://kubernetes.io/docs/concepts/cluster-administration/networking/)) is
...
1. vNICs and HNS endpoints of containers are being deleted
   ...
   [kube-proxy](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-proxy/). To resolve
...
1. DNS resolution is not properly working
   ...
   Check the DNS limitations for Windows in this [section](https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#dns-windows).
