...
| Repository/tooling foundation | Implemented and locally verified through EG-021; successful exact-commit CI remains pending after merge |
...
| R3 release | Pre-stable `0.12.2` is locally verified; successful exact-commit CI, human accessibility review, and EG-014 final `1.0.0` evidence remain |
