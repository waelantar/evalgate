...
|---|---|---|
| [Health/search OpenAPI](openapi/foundation.yaml) | Health merged; search implemented and locally verified on the EG-005 review branch | EG-001, EG-005 |
...
| [Hybrid retrieval policy](retrieval/hybrid-rrf-v1.json) | Accepted; implemented and locally verified on the EG-005 review branch | EG-005 |
