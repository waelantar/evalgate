...
| 13a | [EG-017](EG-017-product-experience.md) product experience | `feat/eg-017-product-experience` | EG-011, EG-013A/B, initial EG-014 audit | R3 | Minor `0.9.0 -> 0.10.0` | `gpt-5.6-terra` / medium |
| 13b | [EG-018](EG-018-real-world-showcase.md) real-world showcase | `feat/eg-018-real-world-showcase` | EG-017 | R3 | Minor `0.10.0 -> 0.11.0` | `gpt-5.5` / high |
...
| 14 | [EG-014](EG-014-release-evidence.md) release finalization | `docs/eg-014-release-final` | EG-013D, EG-015, EG-017, EG-018, EG-019 | R3 | First stable `0.12.0 -> 1.0.0`, gates permitting | `gpt-5.6-terra` / medium |
...
consume `1.0.0`; it recorded blockers while retaining `0.9.0`. EG-017, EG-018, and EG-019 now form the
reviewed product-experience/showcase/onboarding path before EG-014 finalization. The shared version step is
